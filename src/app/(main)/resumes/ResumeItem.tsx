...
export default function ResumeItem({ resume,resumes }: ResumeItemProps) {
  ...
  return (
    <div className="group relative h-[100vh] max-h-[calc(100vh - 230px)] w-full overflow-hidden rounded-lg border border-transparent bg-gray-200 bg-secondary p-3 transition-colors hover:border-border sm:max-h-[460px] md:max-h-[610px] md:w-1/2 lg:max-h-[1010px]">
